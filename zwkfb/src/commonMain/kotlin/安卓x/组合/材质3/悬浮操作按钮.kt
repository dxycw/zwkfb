...
import androidx.compose.ui.unit.dp
import 安卓x.组合.材质3.令牌集.ElevationTokens
import 安卓x.组合.材质3.令牌集.FabPrimaryContainerTokens
...
object 悬浮操作按钮默认值 { // FloatingActionButtonDefaults
     ...
     * @param 按压阴影 当 [FloatingActionButton] 被按下时使用的海拔高度。
     * @param 聚焦阴影 当 [FloatingActionButton] 获得焦点时使用的高度。
     * @param 悬停阴影 当 [FloatingActionButton] 被悬停时使用的高度。
     */
    @Composable
    fun 阴影(
        默认阴影: Dp = FabPrimaryContainerTokens.ContainerElevation,
        按压阴影: Dp = FabPrimaryContainerTokens.PressedContainerElevation,
        聚焦阴影: Dp = FabPrimaryContainerTokens.FocusedContainerElevation,
        悬停阴影: Dp = FabPrimaryContainerTokens.HoveredContainerElevation,
     ...
     * @param 按压阴影 当 [FloatingActionButton] 被按下时使用的高度。
     * @param 聚焦阴影 当 [FloatingActionButton] 获得焦点时使用的高度。
     * @param 悬停阴影 当 [FloatingActionButton] 被悬停时使用的高度。
     */
    @Composable
    fun 降低阴影(
        默认阴影: Dp = ElevationTokens.Level1,
        按压阴影: Dp = ElevationTokens.Level1,
        聚焦阴影: Dp = ElevationTokens.Level1,
        悬停阴影: Dp = ElevationTokens.Level2,
    ): FloatingActionButtonElevation =
...
fun Modifier.动画悬浮操作按钮(
    可见: Boolean,
    对齐: Alignment,
    目标缩放: Float = 悬浮操作按钮默认值.ShowHideTargetScale,
