...
import 安卓x.组合.材质3.令牌集.RichTooltipTokens
...
sealed interface 工具提示范围 { // TooltipScope
    ...
    @FrequentlyChangingValue fun 获取锚点边界(): LayoutCoordinates?
...
fun TooltipScope.富工具提示(
    ...
    色调阴影: Dp = ElevationTokens.Level0,
    视觉阴影: Dp = RichTooltipTokens.ContainerElevation,
    文本: @Composable () -> Unit,
) =
    this.RichTooltip(
        modifier = 修饰符,
...
object 工具提示默认值 { // TooltipDefaults
    ...
    @Composable fun 富工具提示颜色集() = TooltipDefaults.richTooltipColors()
...
object 工具提示锚点位置 {
    ...
    /** 将工具提示放置在锚点上方。 */
    val 上方 = TooltipAnchorPosition.Above

    /** 将工具提示放置在锚点下方。 */
    val 下方 = TooltipAnchorPosition.Below
    ...
    /** 将工具提示放置在锚点的起始位置。 */
    val 开始 = TooltipAnchorPosition.Start
...
interface 工具提示状态 { // TooltipState
    ...
    val 过渡: MutableTransitionState<Boolean>
     ...
     */
    suspend fun 显示(变异优先级: MutatePriority = MutatePriority.Default)
