...
object 开关默认值 { // SwitchDefaults
    ...
    @Composable fun 颜色集() = SwitchDefaults.colors()
...
val SwitchColors.已选中滑块颜色: Color
    get() = this.checkedThumbColor

val SwitchColors.已选中轨道颜色: Color
    get() = this.checkedTrackColor

val SwitchColors.已选中边框颜色: Color
    get() = this.checkedBorderColor

val SwitchColors.已选中图标颜色: Color
    get() = this.checkedIconColor

val SwitchColors.未已选中滑块颜色: Color
    get() = this.uncheckedThumbColor

val SwitchColors.未已选中轨道颜色: Color
    get() = this.uncheckedTrackColor

val SwitchColors.未已选中边框颜色: Color
    get() = this.uncheckedBorderColor

val SwitchColors.未已选中图标颜色: Color
    get() = this.uncheckedIconColor

val SwitchColors.禁用已选中滑块颜色: Color
    get() = this.disabledCheckedThumbColor

val SwitchColors.禁用已选中轨道颜色: Color
    get() = this.disabledCheckedTrackColor

val SwitchColors.禁用已选中边框颜色: Color
    get() = this.disabledCheckedBorderColor

val SwitchColors.禁用已选中图标颜色: Color
    get() = this.disabledCheckedIconColor

val SwitchColors.禁用未已选中滑块颜色: Color
    get() = this.disabledUncheckedThumbColor

val SwitchColors.禁用未已选中轨道颜色: Color
    get() = this.disabledUncheckedTrackColor

val SwitchColors.禁用未已选中边框颜色: Color
    get() = this.disabledUncheckedBorderColor

val SwitchColors.禁用未已选中图标颜色: Color
    get() = this.disabledUncheckedIconColor
