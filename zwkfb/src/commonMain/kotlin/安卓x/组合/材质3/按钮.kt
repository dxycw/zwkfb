...
object 按钮默认值 { // ButtonDefaults
    ...
    val 最小高度
        get() = ButtonDefaults.MinHeight

    /** 超小型按钮容器的默认高度。 */
    val 超小型容器高度 = ButtonDefaults.ExtraSmallContainerHeight

    /** 中型按钮容器的默认高度。 */
    val 中等容器高度 = ButtonDefaults.MediumContainerHeight
    ...
    /** 中型按钮内部使用的图标默认尺寸。 */
    val 中等图标大小 = ButtonDefaults.MediumIconSize
    ...
    val 中等图标间距 = ButtonDefaults.MediumIconSpacing
    ...
    @Composable fun 形状集() = ButtonDefaults.shapes()
    ...
    @Composable fun 按钮颜色集() = ButtonDefaults.buttonColors()
    ...
    @Composable fun 凸起按钮颜色集() = ButtonDefaults.elevatedButtonColors()
    ...
    @Composable fun 轮廓按钮颜色集() = ButtonDefaults.outlinedButtonColors()
    ...
    @Composable fun 文本按钮颜色集() = ButtonDefaults.textButtonColors()
     ...
     * @param 按压阴影 此 [按钮] 处于启用状态且被按下时使用的阴影高度。
     ...
     * @param 按压阴影 此 [凸起按钮] 处于启用状态且被按下时使用的阴影高度。
     ...
     * @param 按压阴影 此 [填充色调按钮] 处于启用状态且被按下时使用的阴影高度。
    ...
    fun 用于形状集(按钮高度: Dp): ButtonShapes =
        ButtonDefaults.shapesFor(buttonHeight = 按钮高度)


    /**
     * 根据提供的按钮高度推荐使用的 [PaddingValues]。
     *
     * 返回的内容内边距基于 ButtonDefaults.<尺寸>ContainerHeight（或小型按钮的 ButtonDefaults.MinHeight）高度值，
     * 并非直接从提供的 buttonHeight 插值计算得出（例如，任何大于等于 ButtonDefaults.MinHeight 且小于
     * ButtonDefaults.MediumContainerHeight 的 buttonHeight 都会返回相同的小型内容内边距）。
     *
     * @param 按钮高度 按钮的高度
     * @param 包含开始图标 按钮是否带有前置图标
     * @param 包含结束图标 按钮是否带有后置图标
     */
    @ExperimentalMaterial3ExpressiveApi
    fun 用于内容内边距(
        按钮高度: Dp,
        包含开始图标: Boolean = false,
        包含结束图标: Boolean = false,
    ): PaddingValues =
    ...
    fun 用于图标大小(按钮高度: Dp): Dp =
        ButtonDefaults.iconSizeFor(buttonHeight = 按钮高度)
    ...
    fun 用于图标间距(按钮高度: Dp): Dp =
        ButtonDefaults.iconSpacingFor(buttonHeight = 按钮高度)
    ...
    fun 用于文本样式(按钮高度: Dp): TextStyle =
        ButtonDefaults.textStyleFor(buttonHeight = 按钮高度)
...
val ButtonColors.容器颜色: Color get() = this.containerColor

val ButtonColors.内容颜色: Color get() = this.contentColor

val ButtonColors.禁用容器颜色: Color get() = this.disabledContainerColor

val ButtonColors.禁用内容颜色: Color get() = this.disabledContentColor
 ...
 * @param 按压形状 是按下状态的形状。
 */
fun 按钮形状集(形状: Shape, 按压形状: Shape) =
    ButtonShapes(shape = 形状, pressedShape = 按压形状)

/** 返回此 ButtonShapes 的副本，可选择性地覆盖部分值。 */
fun ButtonShapes.复制(形状: Shape? = this.shape, 按压形状: Shape? = this.pressedShape) =
    this.copy(shape = 形状, pressedShape = 按压形状)

//=====================================================================

val ButtonShapes.形状: Shape get() = this.shape

val ButtonShapes.按压形状: Shape get() = this.pressedShape
