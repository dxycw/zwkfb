...
val RadioButtonColors.已选择颜色: Color
    get() = this.selectedColor

val RadioButtonColors.未已选择颜色: Color
    get() = this.unselectedColor

val RadioButtonColors.禁用已选择颜色: Color
    get() = this.disabledSelectedColor

val RadioButtonColors.禁用未已选择颜色: Color
    get() = this.disabledUnselectedColor
