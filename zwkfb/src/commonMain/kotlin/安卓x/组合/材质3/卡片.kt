...
import 安卓x.组合.材质3.令牌集.ElevatedCardTokens
import 安卓x.组合.材质3.令牌集.FilledCardTokens
import 安卓x.组合.材质3.令牌集.OutlinedCardTokens
...
object 卡片默认值 { // CardDefaults
    ...
    @Composable
    fun 卡片阴影(
        默认阴影: Dp = FilledCardTokens.ContainerElevation,
        按压阴影: Dp = FilledCardTokens.PressedContainerElevation,
        聚焦阴影: Dp = FilledCardTokens.FocusContainerElevation,
        悬停阴影: Dp = FilledCardTokens.HoverContainerElevation,
        拖拽阴影: Dp = FilledCardTokens.DraggedContainerElevation,
        禁用阴影: Dp = FilledCardTokens.DisabledContainerElevation,
    ): CardElevation =
    ...
    @Composable
    fun 凸起卡片阴影(
        默认阴影: Dp = ElevatedCardTokens.ContainerElevation,
        按压阴影: Dp = ElevatedCardTokens.PressedContainerElevation,
        聚焦阴影: Dp = ElevatedCardTokens.FocusContainerElevation,
        悬停阴影: Dp = ElevatedCardTokens.HoverContainerElevation,
        拖拽阴影: Dp = ElevatedCardTokens.DraggedContainerElevation,
        禁用阴影: Dp = ElevatedCardTokens.DisabledContainerElevation,
    ): CardElevation =
    ...
    @Composable
    fun 轮廓卡片阴影(
        默认阴影: Dp = OutlinedCardTokens.ContainerElevation,
        按压阴影: Dp = 默认阴影,
        聚焦阴影: Dp = 默认阴影,
        悬停阴影: Dp = 默认阴影,
        拖拽阴影: Dp = OutlinedCardTokens.DraggedContainerElevation,
        禁用阴影: Dp = OutlinedCardTokens.DisabledContainerElevation,
    ): CardElevation =
    ...
    @Composable fun 卡片颜色集() = CardDefaults.cardColors()
    ...
    @Composable fun 凸起卡片颜色集() = CardDefaults.elevatedCardColors()
    ...
    fun 轮廓卡片边框(已启动: Boolean = true): BorderStroke =
        CardDefaults.outlinedCardBorder(enabled = 已启动)
...
val CardColors.容器颜色: Color
    get() = this.containerColor

val CardColors.内容颜色: Color
    get() = this.contentColor

val CardColors.禁用容器颜色: Color
    get() = this.disabledContainerColor

val CardColors.禁用内容颜色: Color
