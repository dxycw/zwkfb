...
object 侧边导航栏项默认值 { // NavigationRailItemDefaults
    ...
    @Composable fun 颜色集() = NavigationRailItemDefaults.colors()
...
val NavigationRailItemColors.已选择图标颜色: Color
    get() = this.selectedIconColor

val NavigationRailItemColors.已选择文本颜色: Color
    get() = this.selectedTextColor

val NavigationRailItemColors.已选择指示器颜色: Color
    get() = this.selectedIndicatorColor

val NavigationRailItemColors.未已选择图标颜色: Color
    get() = this.unselectedIconColor

val NavigationRailItemColors.为已选择文本颜色: Color
    get() = this.unselectedTextColor

val NavigationRailItemColors.禁用图标颜色: Color
    get() = this.disabledIconColor
