...
object 导航栏项默认值 { // NavigationBarItemDefaults
    ...
    @Composable fun 颜色集() = NavigationBarItemDefaults.colors()
...
val NavigationBarItemColors.已选择图标颜色: Color
    get() = this.selectedIconColor

val NavigationBarItemColors.已选择文本颜色: Color
    get() = this.selectedTextColor

val NavigationBarItemColors.已选择指示器颜色: Color
    get() = this.selectedIndicatorColor

val NavigationBarItemColors.未已选择图标颜色: Color
    get() = this.unselectedIconColor

val NavigationBarItemColors.未已选择文本颜色: Color
    get() = this.unselectedTextColor

val NavigationBarItemColors.禁用图标颜色: Color
