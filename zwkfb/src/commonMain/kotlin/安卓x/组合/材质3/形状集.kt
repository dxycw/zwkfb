...
// 省略了 None 和 Full 这两种形状，因为 None 对应的是 RectangleShape（矩形），Full 对应的是 CircleShape（圆形）。
val Shapes.超小: CornerBasedShape
    get() = this.extraSmall

val Shapes.小: CornerBasedShape
    get() = this.small

val Shapes.中: CornerBasedShape
    get() = this.medium

val Shapes.大: CornerBasedShape
    get() = this.large

val Shapes.超大: CornerBasedShape
    get() = this.extraLarge



/** 一种四个角大小相同的形状样式，其圆角尺寸大于 [Shapes.medium] 且小于 [Shapes.extraLarge]。[Shapes.large] 的稍大变体。*/
val Shapes.大增加: CornerBasedShape
    get() = this.largeIncreased

/** 一种四个角大小相同的形状样式，其圆角尺寸大于 [Shapes.large] 且小于 [Shapes.extraExtraLarge]。[Shapes.extraLarge] 的稍大变体。*/
val Shapes.超大增加: CornerBasedShape
    get() = this.extraLargeIncreased

/** 一种四个角大小相同的形状样式，其圆角尺寸大于 [Shapes.extraLarge] 且小于 [CircleShape]。*/
val Shapes.超超大: CornerBasedShape
