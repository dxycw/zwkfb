...
object 材质主题 { // MaterialTheme
     ...
     *
     * @param 颜色方案 Material 组件使用的 [颜色方案][ColorScheme]
     * @param 排版 Material 组件使用的 [排版][Typography]
     * @param 形状集 Material 组件使用的 [形状集][Shapes]
     * @param 动画方案 Material 组件使用的 [动画方案][MotionScheme]
     */
    fun 值集(
        颜色方案: ColorScheme = lightColorScheme(),
        排版: Typography = Typography(),
        形状集: Shapes = Shapes(),
        动画方案: MotionScheme = standard(),
    ) =
    ...
    val MaterialTheme.Values.颜色方案: ColorScheme
        get() = this.colorScheme

    val MaterialTheme.Values.排版: Typography
        get() = this.typography

    val MaterialTheme.Values.形状集: Shapes
        get() = this.shapes

    val MaterialTheme.Values.动画方案: MotionScheme
        get() = this.motionScheme
