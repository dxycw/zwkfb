...
fun 键盘选项(
    ...
    @Suppress("AutoBoxing") 自动纠正已启用: Boolean? = null,
...
val KeyboardOptions.自动纠正: Boolean
    get() = this.autoCorrect
 ...
 * 后者永远不会用未指定的值覆盖已指定的值。
 */
fun KeyboardOptions.复制(
    首字母大写: KeyboardCapitalization = this.capitalization,
    @Suppress("AutoBoxing") 自动纠正已启用: Boolean? = this.autoCorrectEnabled,
    键盘类型: KeyboardType = this.keyboardType,
    输入法操作: ImeAction = this.imeAction,
    平台输入法选项: PlatformImeOptions? = this.platformImeOptions,
    @Suppress("AutoBoxing") 显示键盘聚焦回调: Boolean? = null,
...
fun KeyboardOptions.合并(其他: KeyboardOptions?): KeyboardOptions =
    this.merge(other = 其他)


//===================================================================================

val KeyboardOptions.首字母大写: KeyboardCapitalization
    get() = this.capitalization

@Suppress("AutoBoxing")
@get:Suppress("AutoBoxing")
val KeyboardOptions.自动纠正已启用: Boolean?
    get() = this.autoCorrectEnabled

val KeyboardOptions.键盘类型: KeyboardType
    get() = this.keyboardType

val KeyboardOptions.输入法操作: ImeAction
    get() = this.imeAction

val KeyboardOptions.平台输入法选项: PlatformImeOptions?
    get() = this.platformImeOptions

@Suppress("AutoBoxing")
@get:Suppress("AutoBoxing")
val KeyboardOptions.显示键盘聚焦回调: Boolean?
    get() = this.showKeyboardOnFocus

@get:Suppress("NullableCollection")
val KeyboardOptions.提示语言区域: LocaleList?
    get() = this.hintLocales
...
object 键盘选项 {
    ...
    /** [BasicSecureTextField] 的默认 [KeyboardOptions]。 */
    @Stable
    internal val 安全文本字段 =
