...
public interface 对话框接口 extends DialogInterface {
    ...
    interface 取消监听器回调 extends OnCancelListener{
        @Override
    ...
    interface 关闭监听器回调 extends OnDismissListener{
        @Override
    ...
    interface 显示监听器回调 extends OnShowListener{
        @Override
    ...
    interface 单击监听器回调 extends OnClickListener{
        @Override
    ...
    interface 多选单击监听器回调 extends OnMultiChoiceClickListener{
        @Override
    ...
    interface 按键监听器回调 extends OnKeyListener{
        @Override
